...
void newMirroredAgent() {
  float speed = (random(4) + 1) / 4.0;
  int nFrames = random(40, 240);

//  int position = ledsPerStrip / 2 + (random(nStrips)) * 480;
  int position = random(480) + random(nStrips) * 480;
